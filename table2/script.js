...
$(saveBtn).click(function(e){
    ...
    var author = $("#author-inp").val();
    var publisher = $("#publisher-inp").val();
    var year = $("#year-inp").val();
    var pages = $("#pages-inp").val();
    var series = $("#series-inp").val();
    var seriesNum = $("seriesNum-inp").val();
    
    var tr = $("<tr>");

    var uniqueIdTd = $(`<td id="${uniqueId}">`);
    var titleTd = $("<td>");
    var authorTd = $("<td>");
    var publisherTd = $("<td>");
    var yearTd = $("<td>");
    ...
    seriesNumTd.text(seriesNum);
    buttonsTd.html(`<input type="button" value="edit" id="editRow${uniqueId}" /> 
    ...
    $(editRowButton).click(function(){
        ...
        titleTd.html(`<input type="text" value="${title}" id="newTitle-${uniqueId}" />`);
        authorTd.html(`<input type="text" value="${author}" id="newAuthor-${uniqueId}" />`);
        publisherTd.html(`<input type="text" value="${publisher}" id="newPublisher-${uniqueId}" />`);
        yearTd.html(`<input type="text" value="${year}" id="newYear-${uniqueId}" />`);
        pagesTd.html(`<input type="text" value="${pages}" id="newPages-${uniqueId}" />`);
        seriesTd.html(`<input type="text" value="${series}" id="newSeries-${uniqueId}" />`);
        seriesNumTd.html(`<input type="text" value="${seriesNum}" id="newSeriesNum-${uniqueId}" />`);
        ...
        $(saveRowButton).click(function(){
            ...
            title = $(`#newTitle-${uniqueId}`).val();
            author = $(`#newAuthor-${uniqueId}`).val();
            publisher = $(`#newPublisher-${uniqueId}`).val();
            year = $(`#newYear-${uniqueId}`).val();
            pages = $(`#newPages-${uniqueId}`).val();
            series = $(`#newSeries-${uniqueId}`).val();
            seriesNum = $(`#newSeriesNum-${uniqueId}`).val();
